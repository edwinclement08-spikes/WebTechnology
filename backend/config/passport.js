...
module.exports = function(passport) {
    ...
    function(req, email, password, done) {
        ...
        User.findOne({ 'email' :  email }, function(err, user) {
            ...
            // check to see if theres already a record with that email
            if (user) {
                // check whether there's a local user with that email
    ...
    function(req, email, password, done) { // callback with email and password from our form
        ...
        User.findOne({ 'email' :  email }, function(err, user) {
            ...
            if(user.local)   {
                ...
                return done(null, false, req.flash('loginMessage', 'You have a Google or Facebook Account, not a local one.')); // create the loginMessage and save it to session as flashdata
            }
